...
| **Image handling** | expo-image-picker + expo-image-manipulator | Pick from gallery or camera; resize & compress before upload |
...
- [ ] Book search via ISBN / Google Books API (auto-fill title, author, cover)
