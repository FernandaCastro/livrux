const en = {
  ...
  auth: {
    ...
    resendConfirmationEmailIn: 'Resend email ({{seconds}}s)',
    resendConfirmationEmailSent: 'Email sent!',
  ...
  book: {
    ...
    duplicateTitle: 'Book already registered',
    duplicateMessage: 'This book has already been registered for this reader. Would you like to register it again as a re-read?',
    duplicateConfirm: 'Yes, register',
  ...
  settings: {
    ...
    displayNameTooLong: 'Name must be 50 characters or fewer.',
    displayNameSaved: 'Name updated',
    displayNameSavedBody: 'Your display name has been updated successfully.',
    changePassword: 'Change password',
    language: 'Language',
    deleteAccount: 'Delete account',
    deleteAccountConfirm: 'This will permanently delete your account, all readers, and all data. This action cannot be undone.',
  ...
  guardians: {
    menuLabel: 'Co-guardians',
    title: 'Co-guardians',
    subtitle: 'Any added guardian can view and manage the app just like you.',
    members: 'Family members',
    pendingInvitations: 'Pending invitations',
    pendingStatus: 'Invitation sent · waiting',
    unnamed: 'Guardian',
    thisGuardian: 'this guardian',
    inviteBtn: 'Invite guardian',
    haveInvite: 'I have an invitation',
    inviteTitle: 'Invite guardian',
    inviteSubtitle: 'An invitation link will be sent to the provided email.',
    sendInvite: 'Send invitation',
    inviteSentTitle: 'Invitation sent!',
    inviteSentBody: 'The invitation was sent to {{email}}.',
    invalidEmail: 'Please enter a valid email address.',
    acceptTitle: 'Accept invitation',
    acceptSubtitle: 'Enter the code you received in the invitation email.',
    tokenPlaceholder: 'Invitation code',
    tokenRequired: 'Please enter the invitation code.',
    acceptBtn: 'Join family',
    acceptedTitle: 'Welcome!',
    acceptedBody: 'You are now part of this family on Livrux.',
    removeTitle: 'Remove guardian',
    removeConfirm: 'Remove {{name}} from the family?',
    leaveTitle: 'Leave family',
    leaveConfirm: 'You will lose access to this family\'s readers and books.',
    leaveBtn: 'Leave family',
    cancelInviteTitle: 'Cancel invitation',
    cancelInviteConfirm: 'Cancel the invitation sent to {{email}}?',
  },
};
